...
5. Выполнение операции:
   В зависимости от введенной операции программа выполняет соответствующее арифметическое действие:
...
Сначала проверяется, является ли второе число нулем. Если да, выводится сообщение об ошибке.
В противном случае выводится результат деления x на y.
